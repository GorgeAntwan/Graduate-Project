...
export default function CourseReport() {
  ...
  const [practicalDataa, setPracticalDataa] = useState<iBarData>(second);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://127.0.0.1:8000/api/Admin/total_doctor/${idDoctor}/${id}`,
        token
      )
      .then((response: any) => {
        ...
        const pDatasets = {
          ...practical.datasets[0], //practical
          data: [
            response.data[1][0].t_15,
            response.data[1][0].t_21,
            response.data[1][0].t_22,
            response.data[1][0].t_23,
            response.data[1][0].t_24,
            response.data[1][0].t_25,
            response.data[1][0].t_26,
            response.data[1][0].t_27,
            response.data[1][0].t_28,
          ],
        };
        ...
        /////////////////////
        const sDatasets = {
          ...second.datasets[1], //practical
          data: [
            response.data[1][1].t_15,
            response.data[1][1].t_21,
            response.data[1][1].t_22,
            response.data[1][1].t_23,
            response.data[1][1].t_24,
            response.data[1][1].t_25,
            response.data[1][1].t_26,
            response.data[1][1].t_27,
            response.data[1][1].t_28,
          ],
        };
      ...
      axios
      .get(
        `http://127.0.0.1:8000/api/Admin/get_comment/${id}/${idDoctor}`,
        token
      )
      .then((response) => {
  ...
  return (
    <div>
      {hasError ? (
        <Alert severity="error">not found result yet</Alert>
      ) : (
        <>
          <Bar
            data={theoriticalData}
            options={options}
            width={100}
            height={50}
          />
          ...
          <Bar data={practicalDataa} options={options} width={100} height={50} />
