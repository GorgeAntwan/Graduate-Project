  ...
  return (
    <div>
      ...
      <img src="images/aqua.jpg" width="460px" height="350px" />
        ...
        <a className="et-hero-tab" href="/login">
        <HomeIcon/> 
          </a>
          <Hidden smDown>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6}>
          <img src="images/dr.jpg"  width="140px" height="140px" title="Dr: Azza Abd-Elrahman"/> 
          </Grid>
          <Grid item xs={6}>
          <img src="images/dr.jpg"  width="140px" height="140px"  title="Dr: Naglaa Mohamed"/>
          </Grid>
          <Grid item xs={6}>
